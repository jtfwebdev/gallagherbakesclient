...
const Featured = ({ products }: { products: SingularProduct[] | null }) => {
              ...
              if (idx < 4) {
                return (
                  ...
                  >
                    ...
                    <motion.p
                      className="text-secondary-100 font-text flex-1 flex items-center"
                      variants={textVars}
                    >
                      {product.name}
                    </motion.p>
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      <FontAwesomeIcon
                        className="text-secondary-100 text-lg p-2 hover:cursor-pointer hover:opacity-80 duration-150"
                        icon={faCartPlus}
                      />
                    </div>
                  </motion.div>
